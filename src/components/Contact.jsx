...
const Contact = () => {
  ...
  // WhatsApp number for notifications (without +)
  const WHATSAPP_NUMBER = "916386786494";
...
📅 Sent from Portfolio Website`;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      sendWhatsAppMessage(formData.name, formData.email, formData.message);
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="max-w-2xl mx-auto text-white/40 mt-6 text-lg">
            Have a project in mind? Let's connect on WhatsApp!
          </p>
        </div>
            ...
            >
              ...
              {card.link ? (
                <a
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'perspective(1000px) rotateX(3deg) rotateY(3deg) translateZ(20px)';
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  {card.title === "WhatsApp" && (
                    <div className="mt-3 flex items-center gap-1 text-sm text-green-400 opacity-0 group-hover:opacity-100 transition">
                      Start Chat →
                    </div>
                  )}
                  {card.title === "LinkedIn" && (
                    <div className="mt-3 flex items-center gap-1 text-sm text-indigo-400 opacity-0 group-hover:opacity-100 transition">
                      View Profile →
                    </div>
                  )}
                  {card.title === "Phone" && (
                    <div className="mt-3 flex items-center gap-1 text-sm text-purple-400 opacity-0 group-hover:opacity-100 transition">
                      Call Now →
                    </div>
                  )}
                </a>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl shadow-black/50 p-8 md:p-10 hover:shadow-2xl transition-all duration-500">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold text-white">Send Me a WhatsApp Message</h3>
            </div>
            ...
            <div className="mb-6 p-4 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/20 rounded-xl backdrop-blur-sm">
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-r from-green-500 to-emerald-500 flex items-center justify-center text-white text-xl animate-pulse shadow-lg shadow-green-500/30">
                    <svg 
                      viewBox="0 0 24 24" 
                      className="w-6 h-6 fill-current text-white"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div>
                    <p className="text-green-300 font-medium">Connect via WhatsApp</p>
                    <p className="text-green-400/60 text-sm">I'll respond within 24 hours</p>
                  </div>
                </div>
            ...
            {isSubmitted && (
              <div className="mb-6 p-4 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/20 rounded-xl flex items-center gap-3 animate-slide-down backdrop-blur-sm">
                ...
                <div>
                  <p className="text-green-300 font-medium">WhatsApp opened successfully!</p>
                  <p className="text-green-400/60 text-sm">Your message has been prepared</p>
                </div>
              </div>
            )}
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <svg 
                      viewBox="0 0 24 24" 
                      className="w-5 h-5 fill-current text-white group-hover:translate-x-1 group-hover:-translate-y-1 transition"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                    </svg>
      ...
      {/* Floating WhatsApp Button with 3D effect */}
      <a
